...
def avgDmg(weapon):
    # (avgBaseDmg * critDmg * accuracy * critChance) + (avgBase * accuracy)
    avgBaseDmg = (weapon.dmgRange[0] + weapon.dmgRange[1])/2
    acc = weapon.accuracy/100
    critChance = weapon.critChance/100
    return ((avgBaseDmg * weapon.critDmg * acc * critChance) + (avgBaseDmg * (acc - (acc * critChance)))), (weapon.dmgRange[1] * weapon.critDmg * weapon.multiHit)


# for weapon in list(swordsDict):
#     weapon = swordsDict[weapon]
#     print(weapon.name+":", avgDmg(weapon))
# for weapon in list(bowsDict):
#     weapon = bowsDict[weapon]
#     print(weapon.name+":", avgDmg(weapon))
